...
import { useRizkiContext, handleMenuOpen, handleDrawerToggle } from "context";
...
const NavItem = ({ item, level }) => {
  ...
  const { isOpen, borderRadius } = init;
  ...
  const itemHandler = (id) => {
    handleMenuOpen(action, id);
    if (matchesSM) handleDrawerToggle(action, false);
  };
