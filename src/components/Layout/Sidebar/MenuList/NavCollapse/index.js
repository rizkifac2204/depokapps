...
import { useRizkiContext, handleDrawerToggle, handleDarkMode } from "context";
...
const NavCollapse = ({ menu, level }) => {
  ...
  const { isOpen, opened, borderRadius, fontFamily, darkMode } = init;
